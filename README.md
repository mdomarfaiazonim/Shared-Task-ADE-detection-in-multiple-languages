...
System submission for SMM4H-HeaRD 2026 Task 1 — Binary classification of multilingual social media posts for Adverse Drug Event (ADE) detection.
...
Results
ModelDev Macro F1XLM-RoBERTa Base0.810XLM-RoBERTa Large0.841

Setup
bashpip install transformers datasets scikit-learn torch accelerate pandas

Team
NameAffiliation[Mohammed Omar Faiaz][CUET][Abir Dey][CUET]
